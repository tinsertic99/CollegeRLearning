...
#Lower tail vraća strogo (strogo veće od 18), a nama treba veće ili jednako
...
#Ako smanjimo razinu značajnosti, smanjuje se kritično područje.
...
#2.1 kao sto je Darku rjesio asistent
#Funkcija jakosti  Pearsonovog testa
curve(1-pchisq(qchisq(0.95,df = 5), df = 5, ncp=x), from = 0, to = 50)
