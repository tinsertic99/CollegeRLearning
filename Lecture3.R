...
#Ovo gore su parametri, i dobivamo vjerojatnost (funkcija distribucije) da izvucemo manje ili jednako èetiri bijele kuglice
?phyper()
...
#Zadaci
#Uèitavanje podataka
#Uèitamo sa import datasetom portiri.dat
nrow(podaci)
ncol(podaci)
x <- podaci$V1
x <- podaci[,1]
...
?Hypergeometric()
#Hipergeomtrijska - biramo bijele loptice iz crno/bijele kutije i ne vraæamo loptice nazad
